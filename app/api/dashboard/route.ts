...
export async function GET(request: NextRequest) {
  ...
  const { data: appsRaw, error: appsErr } = await supabase
    ...
    .select(
      ...
      'stripe_transfer_id, payout_initiated_at, payout_completed_at, payout_net_amount, ' +
  ...
  const p = profile as (typeof profile & { payout_method_configured?: boolean; stripe_onboarding_complete?: boolean }) | null;
