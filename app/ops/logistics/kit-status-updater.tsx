  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, paddingTop: 8, borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
        <div>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#4a6050', marginBottom: 3, letterSpacing: '1px', textTransform: 'uppercase' }}>Ship</p>
        ...
        <div>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#4a6050', marginBottom: 3, letterSpacing: '1px', textTransform: 'uppercase' }}>Collect</p>
        ...
        <div>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#4a6050', marginBottom: 3, letterSpacing: '1px', textTransform: 'uppercase' }}>Return</p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
        <div>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#4a6050', marginBottom: 3, textTransform: 'uppercase', letterSpacing: '1px' }}>Tracking #</p>
          <input value={tracking} onChange={(e) => setTracking(e.target.value)} placeholder="e.g. 1Z999..." style={TEXT} />
        </div>
        <div>
          <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#4a6050', marginBottom: 3, textTransform: 'uppercase', letterSpacing: '1px' }}>Lab ref #</p>
          <input value={labRef} onChange={(e) => setLabRef(e.target.value)} placeholder="Lab reference" style={TEXT} />
        </div>
      </div>

      <div>
        <p style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#4a6050', marginBottom: 3, textTransform: 'uppercase', letterSpacing: '1px' }}>Notes</p>
